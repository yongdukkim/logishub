...
import com.logishub.mobile.launcher.v5.Common.HTTPUtil;
...
public class GeoLocationFinder {
    public static final int WAITING_TIME = Define.GEO_LOCATION_UPDATE_TIME;
            ...
            if(_currentBestLocation != null) {
                try {
                    ...
                    if (_enabledGPS && _isReadyGPS) {
                        ...
                        String url = Define.LOGISHUB_WEB_DEFAULT + "/GeoLocationLogger.ashx";
