...
public class ServiceMenuAdapter extends ArrayAdapter
{
    Context mContext;
    String[] mSubMenuImage;
    String[] mSubMenuName;
    String mMenuType;

    public ServiceMenuAdapter(Context context, String[] subMenuImages, String[] subMenuNames, String menuType)
    {
        super(context, 0);
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        String url = mSubMenuImage[position];
        Picasso.with(mContext)
                .load(url)
                .error(R.drawable.ic_notification_s)
                .fit()
                .centerCrop().into(holder.ivSubMenu);
