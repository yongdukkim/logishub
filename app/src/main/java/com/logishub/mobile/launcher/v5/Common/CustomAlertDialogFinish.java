...
public class CustomAlertDialogFinish extends Dialog {
    public CustomAlertDialogFinish(final Context context, String message) {
        super(context);
        ...
        View view = inflater.inflate(R.layout.custom_alert_dialog_finish, null);
